...
Android version codes are derived as `MAJOR * 1,000,000 + MINOR * 1,000 + PATCH`. Keep the `pubspec.yaml` build suffix equal to that value so standalone and Suite releases remain monotonic and interchangeable.
